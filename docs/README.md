...
| [ROADMAP.md](docs/ROADMAP.md) | what's left to do, and why each thing sits where it does |
| [sound-selection.md](docs/sound-selection.md) | how the reader decides what to say on a tap |
